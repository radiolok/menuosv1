 ...
 */
#define glcdData0Pin        PIN_L0
#define glcdData1Pin        PIN_L1
#define glcdData2Pin        PIN_L2
#define glcdData3Pin        PIN_L3
#define glcdData4Pin        PIN_L4
#define glcdData5Pin        PIN_L5
#define glcdData6Pin        PIN_L6
#define glcdData7Pin        PIN_L7

/* Arduino pins used for Commands
 * default assignment uses the first five analog pins
 */
#define glcdCSEL1        PIN_D1
#define glcdCSEL2        PIN_D0
...
#define glcdRW            PIN_D3
#define glcdDI            PIN_D2
#define glcdEN            PIN_D4
// Reset Bit  - uncomment the next line if reset is connected to an output pin
#define glcdRES            PIN_D7    // Reset Bit
