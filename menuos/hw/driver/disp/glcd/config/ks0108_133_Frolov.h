 ...
 */
#define glcdData0Pin        PIN_D0
#define glcdData1Pin        PIN_D1
#define glcdData2Pin        PIN_D2
#define glcdData3Pin        PIN_D3
#define glcdData4Pin        PIN_D4
#define glcdData5Pin        PIN_D5
#define glcdData6Pin        PIN_D6
#define glcdData7Pin        PIN_D7

/* Arduino pins used for Commands
 * default assignment uses the first five analog pins
 */
#define glcdCSEL1        PIN_L6
#define glcdCSEL2        PIN_L7
...
#define glcdRW            PIN_L4
#define glcdDI            PIN_L3
#define glcdEN            PIN_L2
// Reset Bit  - uncomment the next line if reset is connected to an output pin
#define glcdRES            PIN_L5    // Reset Bit
